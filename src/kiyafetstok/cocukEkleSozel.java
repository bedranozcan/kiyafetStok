 ...
 * @author ali_k
 */
public class cocukEkleSozel extends javax.swing.JFrame {

    /**
     * Creates new form ErkekEkle
     */
    public cocukEkleSozel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cocukEkleSozel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cocukEkleSozel().setVisible(true);
            }
        });
    }
