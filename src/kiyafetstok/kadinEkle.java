 ...
 * @author ali_k
 */
public class kadinEkle extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kadinEkle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
